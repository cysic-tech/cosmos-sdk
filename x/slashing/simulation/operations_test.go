...
func TestSimulateMsgUnjail(t *testing.T) {
	...
	app.DistrKeeper.SetDelegatorStartingInfo(ctx, validator0.GetOperator(), val0AccAddress.Bytes(), distrtypes.NewDelegatorStartingInfo(2, sdk.OneDec(), 200, sdk.ZeroDec()))
